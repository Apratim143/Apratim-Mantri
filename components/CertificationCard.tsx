...
export const CertificationCard: React.FC<CertificationCardProps> = ({ cert }) => {
  return (
    <div className="min-w-[300px] md:min-w-[360px] snap-center flex flex-col bg-white dark:bg-[#151520] border border-gray-200 dark:border-white/5 rounded-2xl overflow-hidden hover:shadow-xl dark:hover:shadow-[0_0_30px_rgba(0,0,0,0.3)] transition-all duration-300 group">
